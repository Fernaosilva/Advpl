...
Local cDesc3         := "Instrumentos para Calibração"
Local cPict          := ""
Local titulo       := "Instrumentos para Calibração"
Local nLin         := 80

Local Cabec1       := "                                        Dt.Proxima"
Local Cabec2       := "Codigo  Descrição                       Calibração     Responsável"
Local imprime      := .T.
Local aOrd := {}
Private lEnd         := .F.
...
Private limite           := 80
Private tamanho          := "P"
Private nomeprog         := "Instr" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo            := 18
Private aReturn          := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey        := 0
Private cPerg       := "SZ6REL"
...
cCod  :=	""	// variavel para guardar o codigo do instrumento
 cNome :=	""	// Variavel para guardar o nome do instrumento
...
While !EOF()
   ...
   Endif
	...
	While 	cCod == Z6_ZZNUM 
			cData:= DtoS(Z6_ZZPROXC)
			
			If (cData>=cDtIni .and. cData<=cDtFin)
			//alert(cCod)
			@nLin,00 PSAY cCod picture "@!"
			@nLin,08 PSAY Posicione ("SZ5",1,XFilial("SZ5")+Z6_ZZNUM,"Z5_ZZDESCR") Picture "@!"
			@nLin,40 PSAY Z6_ZZPROXC 
			@nLin,55 PSAY Posicione ("SZ5",1,XFilial("SZ5")+Z6_ZZNUM,"Z5_ZZRESP") Picture "@!"  
