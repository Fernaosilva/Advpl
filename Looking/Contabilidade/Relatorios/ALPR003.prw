...
±±³Programa  ³ ALPR003  ³ Autor ³ Natanael Delatorre    ³ Data ³ 03/01/08 ³±±
±±³Programa  ³ ALPR003  ³ Alterado por Donizete/Marcondes        19/03/08 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descrição ³ Razonete de Cliente/Fornecedores que tenham saldo financei-³±±
±±             ro ou contábil diferentes de zero                          ´±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ Personalizado para o cliente Looking                        ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
User Function ALPR003()
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
wnrel := "ALPR003"            //Nome Default do relatorio em Disco
...
RptStatus({|lEnd| ALPR3a(@lEnd,wnRel,cString)},titulo)
Return
...
*/
Static Function ALPR3a(lEnd,wnRel,cString)
...
//Looking
Local lALPImpr		:= .F.		// Flag que indica se imprime
Private cAlpTipos	:= ''		// Tipos de títulos personalizados
//Looking
...
If mv_par11 == 1
	//Looking
	// Criado rotina personalizada para escolha dos tipos já com a pré-escolha
	// pelo parâmetro MV_PAR25
	//finRTipos()
	cAlpTipos	:= AllTrim( GetMV("MV_ZZTIPO" + Str( MV_PAR25, 1)))
	u_AlpFinTp()
	//Looking
Endif
...
If mv_par14 == 1
	...
	cabec1 := "DATA       HISTORICO             PRF NUMERO        PC  DT.CONT.   VENCTO     BAIXA             DEBITO        CREDITO     SALDO ATUAL"
Else
...
While !Eof()
	...
	If nSaldoAtu = 0 .And. aSdoContabil[1] = 0
		nSaldoAtu		:= 0
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡„o    ³AlpFinTp  ³ Autor ³ Natanael Delatorre    ³ Data ³ 08/01/08 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³Abre tela com tipos de titulos.                             ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³Sigafin, baseado na rotina padrão finrtipos                 ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
User Function AlpFinTp()
LOCAL cCapital
LOCAL nX
...
While X5_FILIAL+X5_tabela == cFilial+"05"
	...
	// Verifica se o tipo da X5 está no Grupo de Tipos do parâmetro Personalizado MV_ZZTIPO?
	lOk	:= Iif( SubStr(X5_CHAVE,1,3) $ cAlpTipos, .T., .F.)
...
//		cCapital+Space(15-Len(cCapital)))})
	...
	Aadd(aTipos,{ lOk,SubStr(X5_CHAVE,1,4)+Iif(Len(cCapital)>15,;
		SubStr(cCapital,1,15),;
		cCapital+Space(15-Len(cCapital)))})
//Looking
	dbSkip( )
...
For a=1 to 5
	...
	Aadd( aHelpPor, "Grupo " + Str(a,1) + ": " + AllTrim( GetMV("MV_ZZTIPO"+Str(a,1)) + Chr(10) + Chr(13) + Chr(10) + Chr(13)))
...
PutSx1( "FIN550", "25","Grupo de Tipos de Titulos","Grupo de Tipos de Titulos","Grupo de Tipos de Titulos","mv_chq","N",1,0,1,"C","","","","","mv_par25","1-Grupo 1","1-Grupo 1","1-Grupo 1","","2-Grupo 2","2-Grupo 2","2-Grupo 2","3-Grupo 3","3-Grupo 3","3-Grupo 3","4-Grupo 4","4-Grupo 4","4-Grupo 4","5-Grupo 5","5-Grupo 5","5-Grupo 5",aHelpPor,aHelpEng,aHelpSpa,".FIN55025.")
