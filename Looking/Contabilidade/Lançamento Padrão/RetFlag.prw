...
±±ºData      ³ Alterações                                                 º±±
±±º09/02/08  ³ Donizete: o programa não abria o CTB em função do módulo.  º±±
±±º          ³Agora permite ver os lançamentos pois altero o nmodulo e o  º±±
±±º          ³cmodulo.                                                    º±±
±±º          ³                                                            º±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
Public lMarca	:= .t.
Public _lMostra := .t.
Public _nModOld	:= nModulo
Public _cModOld := cModulo
...
Static Function SUB01
	...
	If nOpcao == 1
		...
		@ 80,090 Button OemToAnsi("NFE") Size 15,13 Action XMATA103()
		@ 80,107 Button OemToAnsi("TES") Size 15,13 Action MATA080()
		@ 80,124 Button OemToAnsi("PRO") Size 15,13 Action MATA010()
		@ 80,141 Button OemToAnsi("LP ") Size 15,13 Action CTBA080()
		@ 80,158 Button OemToAnsi("FOR") Size 15,13 Action CFGX019()
		@ 80,175 Button OemToAnsi("CTB") Size 15,13 Action (nModulo:=34, cModulo:= "CTB",CTBA102(),nModulo:=_nModOld,cModulo:=_cModOld)
	...
	ElseIf nOpcao == 2
		...
		@ 80,020 BMPBUTTON TYPE 01 ACTION SUB02()
		@ 80,050 BMPBUTTON TYPE 02 ACTION Close(oMyDlg1)
		@ 80,090 Button OemToAnsi("NFS") Size 15,13 Action MATC090()
		@ 80,107 Button OemToAnsi("TES") Size 15,13 Action MATA080()
		@ 80,124 Button OemToAnsi("PRO") Size 15,13 Action MATA010()
		@ 80,141 Button OemToAnsi("LP ") Size 15,13 Action CTBA080()
		@ 80,158 Button OemToAnsi("FOR") Size 15,13 Action CFGX019()
...
If nOpcao == 1
	...
	Else
		...
		Alert("(RetFlag) Nf não encontrada -> " + _cSerie + "/" + _cNf)
	EndIf
